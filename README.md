...
Forks are welcome — it is GPL-3.0, that is the point. This repository is where the work happens.
...
cause is a cloud-synced install folder — move it out of OneDrive and try again.

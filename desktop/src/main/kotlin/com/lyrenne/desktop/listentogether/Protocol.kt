...
sealed class ListenTogetherEvent {
    ...
    // Suggestion events
    data class SuggestionReceived(val payload: SuggestionReceivedPayload) : ListenTogetherEvent()
    data class SuggestionApproved(val payload: SuggestionApprovedPayload) : ListenTogetherEvent()
    data class SuggestionRejected(val payload: SuggestionRejectedPayload) : ListenTogetherEvent()
